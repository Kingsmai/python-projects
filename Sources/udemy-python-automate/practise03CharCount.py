import pprint # import pretty print function

# Below is just a test message, the code is start from 4855 lines 
...
for char in message.upper(): # whenever the letter is Uppercase or lowercase
    count.setdefault(char, 0) # if dictionary didn't letter, then set default 0
    count[char] += 1 # count the letter

# pprint.pprint(count)

# To return the pprint string, just:
